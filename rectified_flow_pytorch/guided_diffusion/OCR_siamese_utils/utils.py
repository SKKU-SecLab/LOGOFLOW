...
def resolution_alignment(img1, img2):
    ...
    if w_min == 0 or h_min == 0:  ## something wrong, stop resizing
        return img1, img2
    if w_min < h_min:
        img1_resize = img1.resize(
            (int(w_min), math.ceil(h1 * (w_min / w1)))
        )  # ceiling to prevent rounding to 0
...
def brand_converter(brand_name):
    ...
    if brand_name == "Adobe Inc." or brand_name == "Adobe Inc":
        ...
        brand_name == "DHL Airways, Inc."
        or brand_name == "DHL Airways, Inc"
        or brand_name == "DHL"
    ):
        return "DHL Airways"
        ...
        brand_name == "Microsoft OneDrive"
        or brand_name == "Office365"
        or brand_name == "Outlook"
    ):
        return "Microsoft"
