...
parser.add_argument(
    "--aug", action="store_true", default=False, help="whether use data augmentation."
)
parser.add_argument(
    "--lexicon_type",
    type=str,
    default="0",
    choices=["0", "50", "1k", "full"],
...
parser.add_argument(
    "--decoder_sdim", type=int, default=512, help="the dim of hidden layer in decoder."
)
...
parser.add_argument(
    "--logs_dir", type=str, metavar="PATH", default=osp.join(working_dir, "logs")
)
parser.add_argument(
    "--real_logs_dir",
    type=str,
...
parser.add_argument(
    "--debug", action="store_true", help="if debugging, some steps will be passed."
)
parser.add_argument(
    "--vis_dir",
    type=str,
