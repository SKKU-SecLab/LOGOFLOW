...
import src.phishpedia_siamese.siamese_retrain.bit_hyperrule as bit_hyperrule
...
def argparser(known_models):
    ...
    parser.add_argument(
        "--weights_path", help="Load weights from a pretrained model, i.e. bit.pth.tar."
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="For the few-shot variant, use this many examples " "per class only.",
    )
    parser.add_argument(
